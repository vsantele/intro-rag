# From https://github.com/Raudaschl/rag-fusion
# Updated to use OpenAI >= 1.0.0
import os
...
# If you want to use a different base URL, you can set it here
# (like local llm or Mistral)
base_url = None
...
def generate_queries_chatgpt(original_query):
    ...
    response = client.chat.completions.create(
        model="gpt-3.5-turbo",  # not used if local llm
        messages=[
            {
                "role": "system",
